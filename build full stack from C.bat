...
rmdir /s /q  "C:/GitHub/Seff/binHostingRhino"
rmdir /s /q  "C:/GitHub/Seff/binHosting"
@REM dotnet build "C:/GitHub/Seff/SeffHostingRhino.fsproj" --configuration Release
dotnet build "C:/GitHub/Seff/SeffHosting.fsproj" -p:Platform=x64 --configuration Release

:: Rhino7
rmdir /s /q  "C:/GitHub/Seff.Rhino/binRh7"
dotnet build "C:/GitHub/Seff.Rhino/Seff.Rhino7.fsproj" --configuration Release
rmdir /s /q  "C:/GitHub/Rhino.Scripting/binRh7"
dotnet build "C:/GitHub/Rhino.Scripting/Rhino.Scripting7.fsproj" --configuration Release
...
@REM dotnet build "C:/GitHub/Seff.Rhino/Seff.Rhino6.fsproj" --configuration Release
